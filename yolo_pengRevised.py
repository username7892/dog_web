...
def main():
    ...
    # ========== 新增：从前端获取需要显示的类别 ==========
    from web_server import get_display_classes  # 假设web_server有这个函数
    # 如果没有，可以用全局变量或共享内存，这里用一个简单的方式
    display_classes = set()  # 空集合表示全部显示
    ...
    while True:
        ...
        try:
            ...
            # 获取前端选中的类别
            display_classes = get_display_classes()  # 从web_server获取
